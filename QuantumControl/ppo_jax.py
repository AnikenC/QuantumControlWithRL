...
total_timesteps = 100000 # total timesteps of the experiment
learning_rate = 0.0015 # the learning rate of the optimizer
num_envs = 1 # the number of parallel environments
num_steps = 256 # the number of steps to run in each environment per policy rollout
...
def rollout(
    ...
    for step in range(0, num_steps):
        ...
        for info in infos["final_info"]:
            ...
            if info is None:
                continue
            writer.scalar("charts/episodic_return", info["mean reward"], global_step)
            writer.scalar("charts/episodic_length", info["average fidelity"], global_step)
